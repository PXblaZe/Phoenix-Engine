...
class Mouse {
    ...
    double xChange, yChange, lastx, lasty;
...
public:
    ...
    double getXChange() noexcept;
    double getYChange() noexcept;
...
public:
    ...
    struct KeyboardIStream {
        int key, scancode, action, mods;
        std::unordered_map<short, unsigned char> key_action_record;
    } events;
